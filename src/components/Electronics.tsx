        ...
        <div className="text-center mb-16">
          <Reveal>
            <h1 className="text-5xl font-bold mb-6">
              <span className="brand-teal page-title-highlight">Electronics</span> Solutions
            </h1>
          </Reveal>
          <Reveal delay={0.08}>
          ...
          <Reveal>
            <div className="bg-white/5 backdrop-blur-sm rounded-lg p-8 border border-[#24c4c4]/20 hover:border-[#24c4c4]/40 transition-all duration-300 hover:transform hover:-translate-y-2 h-full md:min-h-[360px] flex flex-col">
              <div className="service-card-header">
                <div className="w-16 h-16 bg-[#24c4c4]/20 rounded-full mb-6 flex items-center justify-center icon-bg-container">
