        ...
        <div className="text-center mb-16">
          <Reveal>
            <h1 className="text-5xl font-bold mb-6">
              About <span className="brand-teal about-title-highlight">Intersoft</span> International
            </h1>
          </Reveal>
          <Reveal delay={0.08}>
          ...
          <div className="space-y-8">
            <Reveal>
              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-white/10">
                <h3 className="text-2xl font-bold brand-teal mission-header mb-4">Our Mission</h3>
            ...
            <Reveal delay={0.08}>
              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-white/10">
                <h3 className="text-2xl font-bold brand-red mission-header mb-4">Our Vision</h3>
                <p className="text-gray-300 leading-relaxed">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <Reveal>
            <div className="text-center bg-white/5 backdrop-blur-sm rounded-lg p-8 border border-white/10">
              <div className="w-16 h-16 bg-[#24c4c4]/20 rounded-full mx-auto mb-4 flex items-center justify-center icon-bg-container">
          ...
          <Reveal delay={0.16}>
            <div className="text-center bg-white/5 backdrop-blur-sm rounded-lg p-8 border border-white/10">
              <div className="w-16 h-16 bg-[#bc3723]/20 rounded-full mx-auto mb-4 flex items-center justify-center icon-bg-container">
