        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 bg-white/5 rounded-full flex items-center justify-center hover:bg-[#24c4c4]/20 transition-colors">
                <svg className="w-5 h-5 text-gray-400 hover:text-[#24c4c4]" fill="currentColor" viewBox="0 0 24 24">
            ...
            <ul className="space-y-3">
              <li>
                <a 
                  ...
                  className="text-gray-400 hover:text-[#24c4c4] transition-colors"
                >
              ...
              <li>
                <a href="#" className="text-gray-400 hover:text-[#24c4c4] transition-colors">
                  IoT Solutions
                </a>
              </li>
              <li>
