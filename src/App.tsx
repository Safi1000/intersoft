          ...
          <>
                ...
                <Reveal delay={0.06} durationMs={400}>
                  <section className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm shadow-[0_10px_40px_rgba(0,0,0,0.3)] p-8 mb-16 md:min-h-[680px]">
                    <div className="grid md:grid-cols-2 gap-8 items-center">
                      <div>
                        <h3 className="text-3xl font-bold brand-teal home-service-title mb-4">Electronics Solutions</h3>
                  ...
                  <section className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm shadow-[0_10px_40px_rgba(0,0,0,0.3)] p-8 mb-20 md:min-h-[680px]">
                    <div className="grid md:grid-cols-2 gap-8 items-center">
                      <div className="order-2 md:order-1">
                        <h3 className="text-3xl font-bold brand-red home-service-title mb-4">Software Development</h3>
                        <p className="text-gray-300 mb-6">
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-20">
                  <Reveal>
                    <div className="text-center group">
                      <div className="w-20 h-20 bg-[#24c4c4]/20 rounded-full mx-auto mb-6 flex items-center justify-center group-hover:bg-[#24c4c4]/30 transition-all duration-300 icon-bg-container">
                  ...
                  <Reveal delay={0.08}>
                    <div className="text-center group">
                      <div className="w-20 h-20 bg-[#bc3723]/20 rounded-full mx-auto mb-6 flex items-center justify-center group-hover:bg-[#bc3723]/30 transition-all duration-300 icon-bg-container">
            ...
            <section className="gradient-bg relative overflow-hidden" style={{ marginTop: '0.25rem', paddingTop: '7.8rem', paddingBottom: '7.8rem', minHeight: 'auto', height: 'auto' }}>
              ...
              <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
                <h2 className="text-4xl font-bold mb-8 text-white/80">
                  Ready to Transform Your Business?
                </h2>
                <p className="text-xl text-gray-300 mb-12 leading-relaxed text-white/80">
