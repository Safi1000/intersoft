          ...
          <>
            ...
            <section className="bg-black py-20">
              <div className="max-w-6xl mx-auto px-6">
                ...
                <section className="bg-white/5 backdrop-blur-sm rounded-lg p-8 border border-white/10 mb-16">
                  <div className="grid md:grid-cols-2 gap-8 items-center">
                    <div>
                      <h3 className="text-3xl font-bold text-[#24c4c4] mb-4">Electronics</h3>
                    ...
                    <div className="text-center md:text-right">
                      <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-[#24c4c4]/15 border border-[#24c4c4]/20">
                        <svg className="w-12 h-12 text-[#24c4c4]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <section className="bg-white/5 backdrop-blur-sm rounded-lg p-8 border border-white/10 mb-20">
                  <div className="grid md:grid-cols-2 gap-8 items-center">
                    <div className="order-2 md:order-1">
                      ...
                      <ul className="grid sm:grid-cols-2 gap-3 text-gray-300">
                        <li className="flex items-start gap-3"><span className="w-2 h-2 mt-2 rounded-full bg-[#bc3723]"></span> Web apps (React/Next), mobile apps</li>
                        <li className="flex items-start gap-3"><span className="w-2 h-2 mt-2 rounded-full bg-[#bc3723]"></span> APIs and microservices, GraphQL/REST</li>
                        <li className="flex items-start gap-3"><span className="w-2 h-2 mt-2 rounded-full bg-[#bc3723]"></span> Cloud & DevOps (Docker, Kubernetes, CI/CD)</li>
                        <li className="flex items-start gap-3"><span className="w-2 h-2 mt-2 rounded-full bg-[#bc3723]"></span> Data pipelines, analytics, integrations</li>
                      </ul>
                      <div className="mt-6" style={{ marginTop: '2.5rem' }}>
                    ...
                    <div className="order-1 md:order-2 text-center md:text-left">
                      <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-[#bc3723]/15 border border-[#bc3723]/20">
                        <svg className="w-12 h-12 text-[#bc3723]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {/* Partners Carousel Teaser */}
                <div className="text-center bg-white/5 backdrop-blur-sm rounded-lg p-12 border border-white/10">
                  <h3 className="text-2xl font-bold mb-6">Trusted by Industry Leaders</h3>
                  <p className="text-gray-300 mb-8">
                    We've partnered with Fortune 500 companies and innovative startups to deliver 
                    transformative technology solutions.
                  </p>
                  <div className="flex justify-center items-center gap-12 opacity-60">
                    <div className="text-gray-500 font-bold text-xl">TechCorp</div>
                    <div className="text-gray-500 font-bold text-xl">InnovateLab</div>
                    <div className="text-gray-500 font-bold text-xl">FutureSystems</div>
                    <div className="text-gray-500 font-bold text-xl">GlobalTech</div>
                  </div>
                </div>
              </div>
            </section>
